...
namespace SquaredInfinity.Foundation.Media.Drawing
{
    public abstract partial class PixelCanvas : IPixelCanvas
    {
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public CohenSutherlandOutCode ComputeCohenSutherlandOutCode(Rectangle bounds, double x, double y)
        {
        ...
        /// https://en.wikipedia.org/wiki/Cohen%E2%80%93Sutherland_algorithm
        /// </summary>
        public bool TryCohenSutherlandClip(Rectangle bounds, ref double x0, ref double y0, ref double x1, ref double y1)
        {
