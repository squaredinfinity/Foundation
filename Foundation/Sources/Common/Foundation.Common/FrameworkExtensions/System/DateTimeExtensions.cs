...
namespace SquaredInfinity.Foundation.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        public static DateTime BeginingOfWeek(this DateTime me)
        {
            return BeginingOfWeek(me, CultureInfo.CurrentUICulture.DateTimeFormat.FirstDayOfWeek);
        }

        public static DateTime BeginingOfWeek(this DateTime me, DayOfWeek startOfWeek)
        {
        ...
        /// CN: 23-11-2011
        /// 
        /// This method will automatically use invariant culture to return date
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
