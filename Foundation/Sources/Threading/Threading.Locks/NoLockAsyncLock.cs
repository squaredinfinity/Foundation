...
namespace SquaredInfinity.Threading.Locks
{
    ...
    //    public LockState State => LockState.NoLock;

    //    public IReadOnlyList<int> AllOwnerThreadIds => new int[0];
    ...
    //    public async Task<ILockAcquisition> AcquireLockAsync(LockType lockType) => await Task.FromResult(new _DummyLockAcquisition());

    //    public ILockAcquisition AcquireLock(LockType lockType) => new _DummyLockAcquisition();
    //}
}
