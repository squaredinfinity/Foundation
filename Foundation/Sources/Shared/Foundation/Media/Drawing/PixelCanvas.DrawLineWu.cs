...
namespace SquaredInfinity.Foundation.Media.Drawing
{
 ...
 PixelCanvas
#endif
    {
        ...
        public void DrawLineWu(Rect bounds, int x1, int y1, int x2, int y2, int color)
        {
            var x1_d = (double)x1;
            var y1_d = (double)y1;
            var x2_d = (double)x2;
        ...
        public void DrawLineWu(Rect bounds, int x1, int y1, int x2, int y2, int color, int width)
        {
            var x1_d = (double)x1;
            var y1_d = (double)y1;
            var x2_d = (double)x2;
